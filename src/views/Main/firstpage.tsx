...
const GlobalStyle = createGlobalStyle`
  ...
  body {
    font-family: 'TTLaundryGothicB', sans-serif; /* 폰트 적용 */
  }
`;
...
function FirstMainPage() {
  ...
  return (
    <FirstMainDiv>
      <Filter>
        <GlobalStyle />
        <h1 style={{ textAlign: 'center', color: 'white', fontSize: '4vw', paddingTop: '30vh' }} id='writtext'>
        
        </h1>
        <div style={{ borderBottom: '1px solid white', width: '40vw', margin: '50px auto' }}></div>
        <h2 style={{ color: 'white', textAlign: 'center' }}>안녕 세계! 나에게 프로그래밍 세상을 보여줘서 고마워</h2>
        <h2 style={{ margin: '50px auto', textAlign: 'center', border: '1px solid white', width: '30px', padding: '20px', borderRadius: '50%', color: 'white' }}>v</h2>
      </Filter>
    </FirstMainDiv>
  );
}
